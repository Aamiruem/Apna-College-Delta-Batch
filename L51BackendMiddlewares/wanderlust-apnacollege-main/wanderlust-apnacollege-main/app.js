...
// ✅ SHOW Route (FIXED VARIABLE NAME)
app.get('/listings/:id', wrapAsync(async (req, res) => {
    const { id } = req.params;
    const singleListing = await Listing.findById(id);
    ...
    res.render('listings/show', { listing: singleListing }); // ✅ FIX
}));

// ✅ EDIT Route (FIXED VARIABLE NAME)
app.get('/listings/:id/edit', wrapAsync(async (req, res) => {
    const { id } = req.params;
    const myListing = await Listing.findById(id);
    ...
    res.render('listings/edit', { listing: myListing }); // ✅ FIX
}));
...
app.put('/listings/:id', validateListing, wrapAsync(async (req, res) => {
    ...
    res.redirect(`/listings/${id}`); // ✅ Better redirect
}));
